...
final class IngredientTests: XCTestCase {
    func testDigitsMeasurement() {
        ...
        let ingredient = Ingredient(name: "cherry", measurement: "4321")
        ...
        XCTAssertEqual(Ingredient(name: "foo bar", measurement: "123 456").readableStr, "123 456 of Foo Bar")
        XCTAssertEqual(Ingredient(name: "fizz bUzz", measurement: "456,123").readableStr, "456,123 of Fizz Buzz")
        XCTAssertEqual(Ingredient(name: "foo bizz", measurement: "654.321").readableStr, "654.321 of Foo Bizz")
        
        // WHEN the measurement contains any letters at all
        let almostNumIngredient = Ingredient(name: "sugar", measurement: "123g")
        // THEN the default readable measurement is used
        XCTAssertEqual(almostNumIngredient.readableStr, "123g of Sugar")
        
        // WHEN a unicode number is found
        let oddNumberIngredient = Ingredient(name: "Bar", measurement: "½")
        // THEN the default readable measurement is used
        XCTAssertEqual(oddNumberIngredient.readableStr, "½ of Bar")
        
        // WHEN a typical fraction is found
        let normalNumberIngredient = Ingredient(name: "Bar", measurement: "1/2")
        // THEN the default readable measurement is used
    ...
    func testSuffixedMeasurements() {
        ...
        let ingredient = Ingredient(name: "Lemon", measurement: "Some for frying")
        ...
        XCTAssertEqual(Ingredient(name: "Cheese", measurement: "For Topping On").readableStr, "For Topping On of Cheese")
        
        // WHEN the suffix is "top", regardless of case, THEN readable measurement is suffixed with "topping"
        XCTAssertEqual(Ingredient(name: "Butter", measurement: "ToP").readableStr, "Butter topping")
    }

    func testMeasurementsWithOf() {
        // WHEN a certain set of measurements that use "of" in the middle are found, regardless of case
        let ingredient = Ingredient(name: "lemon", measurement: "jUiCe oF")
        ...
        let containsOddMeasurementWithOf = Ingredient(name: "Cheese", measurement: "some Zest of this")
        ...
        XCTAssertEqual(Ingredient(name: "Basil", measurement: "22 SPRIGS OF THESE LITTLE").readableStr, "22 sprigs of these little Basil")
    }
    ...
    func testPrefixedMeasurements() {
        ...
        let ingredient = Ingredient(name: "tree nuts", measurement: "CRUSHED")
        ...
        XCTAssertEqual(Ingredient(name: "Cheese", measurement: "Quickly grated").readableStr, "Quickly Grated Cheese")
        
        // WHEN a measurement has awkward phrasing but contains one of the set, THEN it will be awkwardly placed in front of the name
        XCTAssertEqual(Ingredient(name: "Cheese", measurement: "Chopped with").readableStr, "Chopped With Cheese")
    }

    func testGarnishReadableMeasurement() {
        // WHEN "garnish" starts the measurement String
        let ingredient = Ingredient(name: "chili flakes", measurement: "Garnish")
        ...
        let ingredientWithGarnishPrefix = Ingredient(name: "Fruit", measurement: "Garnish with some")
        XCTAssertEqual(ingredientWithGarnishPrefix.readableStr, "Garnish with Fruit")
        
        // WHEN "garnish" is randomly placed elsewhere
        let ingredientWithGarnishRandomly = Ingredient(name: "Lemon", measurement: "Some garnish")
        ...
        let ingredientWithAwkwardGarnish = Ingredient(name: "Chili Powder", measurement: "Some garnish of")
    ...
    func testDefaultReadableMeasurement() throws {
        ...
        let ingredient = Ingredient(name: "foo", measurement: "2 cups")
        ...
        let longIngredientName = Ingredient(name: "foo bar fizz buzz", measurement: "2 BLANKS")
        // THEN the lowercased measurement is placed in front of the capitalized name
        XCTAssertEqual(longIngredientName.readableStr, "2 blanks of Foo Bar Fizz Buzz")
        
        // If an unknown measurement is found
        let oddIngredient = Ingredient(name: "Bar", measurement: "123 flowers")
        ...
        let ingredientWithNonNumberUnit = Ingredient(name: "buzz fizz", measurement: "soMe bUnCHes")
        ...
        let oddIngredientWithoutNum = Ingredient(name: "Fizz", measurement: "squares")
        ...
        let oddIngredientWithRandomNum = Ingredient(name: "Buzz", measurement: "Spoons, 2")
